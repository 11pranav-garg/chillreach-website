      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Why Email <span className="text-gradient">Deliverability</span>{' '}
            Matters
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
            In today's digital landscape, reaching the inbox is more challenging
            than ever. Poor deliverability can cripple your email campaigns
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <motion.div whileHover={{ scale: 1.02 }} className="feature-card">
            ...
            <ul className="space-y-3 text-gray-300">
              <li>• Loosing potential Customers</li>
              <li>• Marketing Budget - Down the drain</li>
              {/* <li>• Damaged sender reputation</li> */}
              <li>• Drained out pipeline</li>
            </ul>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} className="feature-card">
            ...
            <ul className="space-y-3 text-gray-300">
              <li>• Removing the Noice of resellers</li>
        ...
        <div className="text-center">
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Don't let poor deliverability hold your business back. With
            ChillReach's expert management - never hear of spam.
          </p>
          <a
